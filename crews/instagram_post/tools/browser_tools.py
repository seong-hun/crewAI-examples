...
def scrape_and_summarize_website(website: str) -> str:
    ...
    url = f"https://production-sfo.browserless.io/content?token={os.environ['BROWSERLESS_API_KEY']}"
    ...
    for chunk in content:
        ...
        task = Task(
            description=dedent(f"""
                Analyze and make a LONG summary the content bellow,
                make sure to include the ALL relevant information in the summary,
